...
const SKILL_SECTIONS = [
  ...
  {
    title: 'Web Dev',
    skills: ['Git', 'Github', 'NPM', 'JavaScript', 'TypeScript', 'Tailwind', 'React', 'Next.js'],
  },
];
        ...
        <div className="space-y-12">
          {SKILL_SECTIONS.map((section) => (
            <div key={section.title}>
              <h3 className="text-xl font-bold text-zinc-800 dark:text-zinc-200 mb-6 border-l-4 border-brand pl-4">{section.title}</h3>
